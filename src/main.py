...
if __name__ == '__main__':
    ...
    snake = Snake(head_start=np.array([0, 0]), colour='blue', num_circles=num_circles, sizes=sizes)

    gui = PygameGUI(bg_colour='white', screen_size=[1_000, 1_000], sim_bounds=np.array([200, 200]), fps=10)
